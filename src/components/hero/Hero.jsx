...
const Hero = () => {
    return (
        <div className="w-full min-h-[65vh] bg-[#F0EDE6] flex items-center overflow-hidden relative py-12 px-6 sm:px-12 lg:px-20 select-none">
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                <div className="lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left space-y-7">
                    ...
                    >
                        Connect with fellow book lovers, discover new stories, 
                        and share your thoughts on the ebooks that move you.
                    </motion.p>
